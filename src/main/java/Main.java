...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int b = scn.nextInt();
        System.out.printf(concatenateStr(a, b, "+", a+b));
        System.out.printf(concatenateStr(a, b, "-", a-b));
        System.out.printf(concatenateStr(a, b, "*", a*b));

        System.out.println("Первый способ замены '=' на 'равно':");
        System.out.printf(wordInsertStringBuilderIbsert(concatenateStr(a, b, "+", a+b)));
        System.out.printf(wordInsertStringBuilderIbsert(concatenateStr(a, b, "-", a-b)));
        System.out.printf(wordInsertStringBuilderIbsert(concatenateStr(a, b, "*", a*b)));

        System.out.println("Второй способ замены '=' на 'равно':");
        System.out.printf(wordInsertStringBuilderReplace(concatenateStr(a, b, "+", a+b)));
        System.out.printf(wordInsertStringBuilderReplace(concatenateStr(a, b, "-", a-b)));
        System.out.printf(wordInsertStringBuilderReplace(concatenateStr(a, b, "*", a*b)));

        getMethodSpeed();
    }
        public static void isReverseWord(){
            Scanner scn = new Scanner(System.in);
    ...
    public static String wordInsertStringBuilderIbsert(String str){
        StringBuilder builder = new StringBuilder(str);
        int begin = builder.indexOf("=");
        return builder.deleteCharAt(begin).insert(begin, " равно ").toString();
    }
    public static String wordInsertStringBuilderReplace(String str) {
        StringBuilder builder = new StringBuilder(str);
        int begin = builder.indexOf("=");
